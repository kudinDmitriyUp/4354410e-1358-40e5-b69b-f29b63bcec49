...
export const metadata: Metadata = {
  title: "Paris Airbnb - Beautiful Apartment in the Heart of Paris",
  description: "Stay in our stunning Paris apartment with modern amenities, prime location, and authentic Parisian charm. Book your perfect Paris getaway today.",
  keywords: "Paris Airbnb, Paris apartment rental, vacation rental Paris, Paris accommodation, stay in Paris",
  metadataBase: new URL("https://parisstay.com"),
  alternates: {
    canonical: "https://parisstay.com"
  },
  openGraph: {
    title: "Paris Airbnb - Your Perfect Parisian Home Away From Home",
    ...
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32fyUI1AepMVfxIUkQhrdGSZ2DN/uploaded-1763135754160-011ozklw.jpg",
        alt: "Beautiful Paris apartment interior"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Paris Airbnb - Beautiful Apartment in Paris",
    description: "Stay in our stunning Paris apartment with authentic charm and modern comfort",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32fyUI1AepMVfxIUkQhrdGSZ2DN/uploaded-1763135754160-011ozklw.jpg"]
  },
  robots: {
    index: true,
    follow: true
